...
export async function createManChildEngine(audioCtx) {
  ...
  const engine = {
    ...
    setThresholdA: (v) => { P('thA').value = v; },
    setThresholdB: (v) => { P('thB').value = v; },
    setDcA:        (v) => { P('dcA').value = v; },
    setDcB:        (v) => { P('dcB').value = v; },
    setVarAtkA:    (v) => { P('varAtkA').value = v; },
    setVarRelA:    (v) => { P('varRelA').value = v; },
    setVarAtkB:    (v) => { P('varAtkB').value = v; },
    setVarRelB:    (v) => { P('varRelB').value = v; },
