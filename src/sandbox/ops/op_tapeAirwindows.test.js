// op_tapeAirwindows.test.js — math tests for #112a Airwindows ToTape9 port.
// Run via: node scripts/check_op_math.mjs

import { TapeAirwindowsOp } from './op_tapeAirwindows.worklet.js';

const SR = 48000;
const N  = 2048;

function freshOp(params = {}) {
  const op = new TapeAirwindowsOp(SR);
...
export default { opId: 'tapeAirwindows', tests };
