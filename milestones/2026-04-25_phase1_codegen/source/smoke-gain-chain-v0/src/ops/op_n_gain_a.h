...
// Template language: Jinja2. smoke-gain-chain-v0 / n_gain_a injected by emitter.
...
class GainOp_n_gain_a {
public:
    static constexpr const char* opId = "gain";

    GainOp_n_gain_a() = default;
    explicit GainOp_n_gain_a(double sampleRate) : sr_(sampleRate) {}
