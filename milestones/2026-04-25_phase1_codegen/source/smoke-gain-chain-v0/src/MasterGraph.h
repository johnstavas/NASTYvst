// MasterGraph — generated from smoke-gain-chain-v0.
...
#include "ops/op_n_gain_a.h"

#include "ops/op_n_gain_b.h"
...
private:
    ...
    shags::ops::GainOp_n_gain_a n_gain_a_;

    shags::ops::GainOp_n_gain_b n_gain_b_;
